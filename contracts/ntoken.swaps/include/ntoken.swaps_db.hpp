...
#define BLINDBOX [[eosio::table, eosio::contract("ntoken.swaps")]]
#define BLINDBOX_NAME(name) [[eosio::table(name), eosio::contract("ntoken.swaps")]]
