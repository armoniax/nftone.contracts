#include "ntoken.swaps_db.hpp"
#include <amax.ntoken/amax.ntoken.hpp>

using namespace std;
using namespace wasm::db;

class [[eosio::contract("ntoken.swaps")]] blindbox: public eosio::contract {
private:
...
public:
    ...
    void createpool( const name& owner,const string& title,const name& asset_contract, const name& blindbox_contract,
                           const nasset& price, const name& fee_receiver, const bool& allow_to_buy_again,
...
private:
    ...
    void _ergodic_nft( pool_t& pool , const name& owner ,deal_trace_t trace);
