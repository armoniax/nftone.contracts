...
struct BLINDBOX_NAME("global") global_t {
    ...
    EOSLIB_SERIALIZE( global_t, (max_exchange_num)(last_pool_id)(last_order_id) )
};
...
struct BLINDBOX buyer_t {
    ...
    EOSLIB_SERIALIZE( buyer_t,   (owner)(buy_num)(created_at)(updated_at)
                               )
};
...
struct BLINDBOX nft_boxes_t {
    ...
    EOSLIB_SERIALIZE( nft_boxes_t,   (id)(quantity)
                               )
};
// scope = contract self
