...
public:
    ...
    [[eosio::on_notify("versontoken2::transfer")]] void ontransnft(const name& from, const name& to, const vector<nasset>& assets, const string& memo);
...
private:
    ...
    void add_amount( const uint64_t& pool_id, const name& owner, const uint64_t& amount);
