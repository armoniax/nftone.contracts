...
#include "rndnft_mart_base_tester.hpp"
...
class rndnft_mart_tester : public rndnft_mart_base_tester {
public:
...
BOOST_FIXTURE_TEST_CASE( init_tests, rndnft_mart_tester ) try {

   // get_table_auditscore("mobileno");
   // wdump(("accaudit:")(accaudit));

   //set account owner to rndnft.mart
   ...
   account_owner_auth.accounts.push_back(permission_level_weight{ {N(rndnft.mart), N(active)}, 1});
...
// BOOST_FIXTURE_TEST_CASE( symbol_already_exists, rndnft_mart_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( create_max_supply, rndnft_mart_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( create_max_decimals, rndnft_mart_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( issue_tests, rndnft_mart_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( retire_tests, rndnft_mart_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( transfer_tests, rndnft_mart_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( open_tests, rndnft_mart_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( close_tests, rndnft_mart_tester ) try {
